package tech.barnard.cordova.plugins.usb;
...
import tech.barnard.cordova.plugins.diagnostic.CCIDDescriptor;
...
public class CCID implements Closeable {
    ...
    public Response transmit(byte cmd, byte[] data, byte rtn, boolean waitIcc) throws IOException {
        ...
        do {
            ...
            Log.v(TAG, String.format("Read %d bytes from BULK-IN: %s", count, bytesToHex(rsp)));
