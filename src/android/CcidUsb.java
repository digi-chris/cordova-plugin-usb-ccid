package tech.barnard.cordova.plugins;
...
import tech.barnard.cordova.plugins.usb.CCID;
import tech.barnard.cordova.plugins.usb.CardCallback;
...
public class CcidUsb extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("connect")) {
            ...
            byte[] dataIn;
            try {
                dataIn = cardReader.transmitApdu(dataOut);
